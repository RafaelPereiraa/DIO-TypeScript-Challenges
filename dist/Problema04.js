...
loginButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let apiKeyContent = document.getElementById('api-key');
...
searchButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let queryContent = document.getElementById('search');
    let query = queryContent.value;
    let listaDeFilmes = yield procurarFilmes(query);
...
searchListButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    let listId = document.getElementById("searchList");
    let lista = document.getElementById("lista");
    if (lista) {
        lista.outerHTML = "";
    }
    let listaDeFilmes = yield pegarLista(listId.value);
    let ul = document.createElement('ul');
    ul.id = "lista";
